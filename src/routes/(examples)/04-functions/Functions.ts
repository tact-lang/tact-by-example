...
const Functions_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text","text":"priviliged"}},
    {"receiver":"internal","message":{"kind":"text","text":"best L1"}},
...
export class Functions implements Contract {
    ...
    readonly abi: ContractABI = {
        types: [{"name":"StateInit","header":null,"fields":[]},{"name":"Context","header":null,"fields":[]},{"name":"SendParameters","header":null,"fields":[]},{"name":"Deploy","header":2490013878,"fields":[]},{"name":"DeployOk","header":2952335191,"fields":[]},{"name":"FactoryDeploy","header":1829761339,"fields":[]},{"name":"TokenInfo","header":null,"fields":[]}],
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'priviliged' | 'best L1' | Deploy) {
        
        let body: Cell | null = null;
        if (message === 'priviliged') {
