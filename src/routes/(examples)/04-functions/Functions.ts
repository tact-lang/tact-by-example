...
const Functions_types: ABIType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "decimals", type: { kind: "simple", type: "uint", optional: false, format: 8 } },
    ],
  },
];
