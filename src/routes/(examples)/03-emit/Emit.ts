...
const Emit_types: ABIType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "recipient", type: { kind: "simple", type: "address", optional: false } },
    ],
  },
  {
    name: "StakeEvent",
