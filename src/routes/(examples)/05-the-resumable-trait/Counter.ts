...
export class Counter implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'increment' | Deploy | 'Resume' | 'Stop') {
