...
export class TodoParent implements Contract {
  ...
  async send(
    ...
    message: "deploy another" | Deploy,
  ) {
    let body: Cell | null = null;
    if (message === "deploy another") {
