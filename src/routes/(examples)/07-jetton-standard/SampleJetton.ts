...
export class SampleJetton implements Contract {
  ...
  readonly abi: ContractABI = {
    types: [
      ...
      { name: "Mint", header: 4235234258, fields: [] },
      { name: "JettonData", header: null, fields: [] },
      { name: "JettonWalletData", header: null, fields: [] },
      { name: "TokenTransfer", header: 260734629, fields: [] },
      { name: "TokenTransferInternal", header: 395134233, fields: [] },
      { name: "TokenNotification", header: 1935855772, fields: [] },
      { name: "TokenBurn", header: 1499400124, fields: [] },
      { name: "TokenBurnNotification", header: 2078119902, fields: [] },
      { name: "TokenExcesses", header: 3576854235, fields: [] },
      { name: "TokenUpdateContent", header: 2937889386, fields: [] },
    ],
  ...
  async send(
    ...
    message: Mint | "Mint: 100" | "Owner: MintClose" | TokenUpdateContent | TokenBurnNotification,
  ) {
