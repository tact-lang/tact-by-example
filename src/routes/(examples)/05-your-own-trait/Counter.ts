...
const Counter_getters: ABIGetter[] = [
    ...
    {"name":"stats","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
...
const Counter_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"text","text":"reset stats"}},
]
