...
const Loops_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"text","text":"out of gas"}},
...
export class Loops implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'loop1' | 'loop2' | 'loop3' | 'out of gas' | Deploy) {
