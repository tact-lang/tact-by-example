...
export class IfStatements implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'check1' | 'check2' | 'check3' | Deploy) {
