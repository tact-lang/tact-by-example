...
export class MessageSender implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'who' | 'hello' | Deploy) {
