...
const Todo1_receivers: ABIReceiver[] = [
...
export class Todo1 implements Contract {
    ...
    readonly abi: ContractABI = {
        ...
        types:  Todo1_types,
        getters: Todo1_getters,
        receivers: Todo1_receivers,
        errors: Todo1_errors,
    };
