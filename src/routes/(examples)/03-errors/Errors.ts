...
export function loadDivide(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 158375295) { throw Error('Invalid prefix'); }
    let _by = sc_0.loadUintBig(32);
    return { $$type: 'Divide' as const, by: _by };
}
...
const Errors_errors: { [key: number]: { message: string } } = {
    ...
    46042: { message: `Counter is too high` },
}

const Errors_types: ABIType[] = [
    ...
    {"name":"Divide","header":158375295,"fields":[{"name":"by","type":{"kind":"simple","type":"uint","optional":false,"format":32}}]},
]

const Errors_getters: ABIGetter[] = [
    {"name":"value","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

const Errors_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text","text":"increment"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Divide"}},
    {"receiver":"internal","message":{"kind":"text","text":"no access"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class Errors implements Contract {
    
    static async init() {
        return await Errors_init();
    }
    
    static async fromInit() {
        const init = await Errors_init();
        const address = contractAddress(0, init);
        return new Errors(address, init);
    }
    
    static fromAddress(address: Address) {
        return new Errors(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types: [{"name":"StateInit","header":null,"fields":[]},{"name":"Context","header":null,"fields":[]},{"name":"SendParameters","header":null,"fields":[]},{"name":"Deploy","header":2490013878,"fields":[]},{"name":"DeployOk","header":2952335191,"fields":[]},{"name":"FactoryDeploy","header":1829761339,"fields":[]},{"name":"Divide","header":158375295,"fields":[]}],
        types:  Errors_types,
        getters: Errors_getters,
        receivers: Errors_receivers,
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'increment' | Divide | 'no access' | Deploy) {
