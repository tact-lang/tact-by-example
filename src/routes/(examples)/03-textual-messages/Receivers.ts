...
const Receivers_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"text","text":"increment by 2"}},
...
export class Receivers implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'increment' | 'decrement' | 'increment by 2' | string | Deploy) {
