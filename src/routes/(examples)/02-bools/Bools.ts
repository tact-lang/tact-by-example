...
const Bools_getters: ABIGetter[] = [
    {"name":"result","arguments":[],"returnType":{"kind":"simple","type":"bool","optional":false}},
]

const Bools_receivers: ABIReceiver[] = [
...
export class Bools implements Contract {
    ...
    readonly abi: ContractABI = {
        ...
        types:  Bools_types,
        getters: Bools_getters,
        receivers: Bools_receivers,
        errors: Bools_errors,
    };
