...
const Todo_getters: ABIGetter[] = [
    {"name":"addressOf","arguments":[{"name":"otherSeqno","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":false}},
]
...
export class Todo implements Contract {
    ...
    async getAddressOf(provider: ContractProvider, otherSeqno: bigint) {
        let builder = new TupleBuilder();
        builder.writeNumber(otherSeqno);
        let source = (await provider.get('addressOf', builder.build())).stack;
