...
export class Receivers implements Contract {
  ...
  async send(
    ...
    message: "increment" | "decrement" | Add | Subtract | MultiMath | "hello" | Deploy,
  ) {
