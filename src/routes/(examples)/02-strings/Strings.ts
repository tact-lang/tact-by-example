...
const Strings_getters: ABIGetter[] = [
    {"name":"result","arguments":[],"returnType":{"kind":"simple","type":"string","optional":false}},
]

const Strings_receivers: ABIReceiver[] = [
...
export class Strings implements Contract {
    ...
    readonly abi: ContractABI = {
        ...
        types:  Strings_types,
        getters: Strings_getters,
        receivers: Strings_receivers,
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: 'show all' | 'show ops' | Deploy) {
