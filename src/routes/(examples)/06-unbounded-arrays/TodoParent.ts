...
const TodoParent_getters: ABIGetter[] = [
  ...
  {
    name: "todoAddress",
    arguments: [{ name: "seqno", type: { kind: "simple", type: "int", optional: false, format: 257 } }],
