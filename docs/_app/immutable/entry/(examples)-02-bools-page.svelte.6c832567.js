var y=Object.defineProperty;var B=(n,e,s)=>e in n?y(n,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):n[e]=s;var A=(n,e,s)=>(B(n,typeof e!="symbol"?e+"":e,s),s);import{S as b,i as f,s as p,I as C,ac as I}from"../chunks/index.9fe14626.js";import{d as r,g,s as u}from"../chunks/store.cab86f52.js";import{d as m}from"../chunks/index.f166c76f.js";const h="# Bools\n\nThis primitive data type can hold the values `true` or `false`.\n\n`Bool` is convenient for boolean and logical operations. It is also useful for storing flags.\n\nPersisting bools to state is very space-efficient, they only take 1 bit.",D=`import "@stdlib/deploy";
