...
There is no \`switch\` statement in Tact. If you need to need to handle a group of outcomes separately, follow the \`else if\` patten you can see in the third example.`,D=`import "@stdlib/deploy";
